...
//    });
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
            drawer: NavigationDrawer(currentDisplayedPage: 12),
            body:new Navigator(
                          key: _navigatorKey,
...
class TopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle aavishkarName = new TextStyle(
        fontFamily: "Orbitron",
        fontSize: 20.0,
        fontWeight: FontWeight.w500,
        color: _darkTextColor
    ...
    TextStyle welcomeToTheNextLevl = new TextStyle(
        fontFamily: "Orbitron",
        fontSize: 15.0,
        fontWeight: FontWeight.w500,
        color: _darkTextColor
...
class MainSceneBackgroundNode extends NodeWithSize {
  ...
  MainSceneBackgroundNode() : super(new Size(320.0, 320.0)) {
    ...
    _bgTop = new Sprite.fromImage(_imageMap["assets/ui_bg_top_tabs.png"]);
    _bgTop.pivot = Offset.zero;
    _bgTop.size = new Size(320.0, 140.0);
    addChild(_bgTop);
