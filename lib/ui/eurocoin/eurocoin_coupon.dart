...
typedef CouponEurocoinItemBodyBuilder<T> = Widget Function(CouponEurocoinItem<T> item);
...
class EurocoinCoupon extends StatefulWidget {
  ...
  EurocoinCoupon({Key key, this.name, this.email, this.parent}):super (key: key);
  final String name;
  final String email;
                ...
                child: Container(
                  child: Theme(
                      ...
                      child: ExpansionPanelList(
                          ...
                          children: _couponEurocoinItem.map((CouponEurocoinItem<dynamic> item) {
